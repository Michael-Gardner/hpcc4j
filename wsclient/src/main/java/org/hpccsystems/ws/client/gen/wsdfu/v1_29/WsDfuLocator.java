...
public class WsDfuLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfu {
    ...
    private java.lang.String WsDfuServiceSoap_address = "http://10.0.2.15:8010/WsDfu?ver_=1.32";
    ...
    public org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoap getWsDfuServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoap getWsDfuServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.wsdfu.v1_29.WsDfuServiceSoapStub(new java.net.URL(WsDfuServiceSoap_address), this);
                _stub.setPortName(getWsDfuServiceSoapWSDDServiceName());
                return _stub;
            }
        }
