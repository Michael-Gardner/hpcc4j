...
import org.hpccsystems.ws.client.gen.wsworkunits.v1_56.NamedValue;

// This class wraps the generated soap ECL Workunit, providing comparable and to-string methods for end-users.
public class WorkunitInfo extends org.hpccsystems.ws.client.gen.wsworkunits.v1_56.ECLWorkunit implements
        Comparable<org.hpccsystems.ws.client.platform.WorkunitInfo>
{
     ...
     * @param base
     */
    public WorkunitInfo(org.hpccsystems.ws.client.gen.wsworkunits.v1_56.ECLWorkunit base)
    {
        copy(base);
    }
     ...
     * @param base
     */
    private void copy(org.hpccsystems.ws.client.gen.wsworkunits.v1_56.ECLWorkunit base)
    {
        if (base == null)
        {
            return;
    ...
    public boolean update(org.hpccsystems.ws.client.gen.wsworkunits.v1_56.ECLWorkunit wu)
    {
    ...
    synchronized boolean updateState(org.hpccsystems.ws.client.gen.wsworkunits.v1_56.ECLWorkunit wu)
    {
        boolean retVal = false;
